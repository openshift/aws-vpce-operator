...
Automated testing and test quality assurance for AWS VPCE Operator.
...
for i in {1..5}; do go test ./pkg/aws_client/ || break; done

# Verbose Ginkgo output
ginkgo -v -trace ./controllers/vpcendpoint/

# Race detector
go test -race ./pkg/aws_client/
```
