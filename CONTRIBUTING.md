...
1. **Setup**: Install Go 1.24+, operator-sdk v1.21.0
2. **Install prek**: `uv tool install prek` (or `pipx install prek`)
3. **Install hooks**: `prek install`
...
- Review the [OWNERS](./OWNERS) file for maintainers and approvers
- Follow the [OpenShift contributing guidelines](https://github.com/openshift/community/blob/master/CONTRIBUTING.md)
