...
Quick reference for developing the Aws Vpce.
...
- **Controllers**: `controllers/{vpcendpoint,vpcendpointacceptance}/` - Reconciliation logic
- **Business Logic**: `controllers/vpcendpoint/` - Resource management
