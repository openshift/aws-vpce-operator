...
// +kubebuilder:validation:XValidation:message=.spec.customDns.route53PrivateHostedZone.autoDiscover is not supported with .spec.region,rule=!(self.region != "" && self.customDns.route53PrivateHostedZone.autoDiscover)
